<x-app-layout>
  ...
  <div class="py-6 mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="rounded-xl bg-white dark:bg-gray-800 shadow ring-1 ring-black/5 p-6">
      <form method="POST" action="{{ route('admin.extra-services.store') }}" class="space-y-5">
        @csrf
        ...
        <div>
          ...
          <textarea name="description" rows="4"
                    class="mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100">{{ old('description') }}</textarea>
        ...
        <div class="flex items-center justify-end gap-2">
          ...
          <button class="px-3 py-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700 text-sm">
            Guardar
          </button>
        </div>
      </form>
