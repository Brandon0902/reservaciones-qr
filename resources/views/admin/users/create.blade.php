  ...
  <x-slot name="header">
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100">Nuevo usuario</h2>
          <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Crea un nuevo usuario en el sistema</p>
        </div>
      </div>
    </div>
  </x-slot>
  ...
  <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50/50 shadow-xl dark:border-gray-700 dark:from-gray-800 dark:to-gray-900/50 ring-1 ring-black/5 p-8">
      <div class="mb-6 flex items-center gap-3 pb-6 border-b border-gray-200 dark:border-gray-700">
        ...
        <div>
          <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Información del usuario</h3>
          <p class="text-sm text-gray-500 dark:text-gray-400">Completa los datos para crear un nuevo usuario</p>
        </div>
      </div>
